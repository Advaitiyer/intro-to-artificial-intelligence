...
class Variable(object):
    ...
    def derivative(self, v):
        ...
        """
        if self is v and self.value==v and self.d_op == v.d_op and self.operands==v.operands:
            return 1
    ...
    def sin(self):
        """
        Returns a new variable that represents sin(self).
        The value is the sine of self's value.
        The d_op of the new variable is chain.d_sin
        The operands of the new variable is the singleton list [self].
        """
        return Variable(
    ...
    def cos(self):
        """
        Returns a new variable that represents cos(self).
        The value is the cosine of self's value.
        The d_op of the new variable is chain.d_cos
        The operands of the new variable is the singleton list [self].
        """
        return Variable(
    ...
    def log(self):
        """
        Returns a new variable that represents log(self).
        The value is the natural logarithm of self's value.
        The d_op of the new variable is chain.d_log
        The operands of the new variable is the singleton list [self].
        """
        return Variable(
