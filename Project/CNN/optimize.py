...
class SGDOptimizer(ParamOptimizer):
    ...
    '''
    def __init__(self, lr_=0.1):
        '''
        Setups hyperparameter for optimizer, but not compiling against specific model
        Args:
            lr_: learn rate
        '''
        self.lr = lr_
...
class AdamSGD(SGDOptimizer):
    def __init__(self, lr_=0.1, beta_=(0.9,0.999), eps_=1e-6):
